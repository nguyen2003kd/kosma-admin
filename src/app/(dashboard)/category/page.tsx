...
import { CategoryMutateDialog } from '@/app/(dashboard)/category/components/category-mutate-dialog'
    ...
    <div>
      ...
      <main className="container mx-auto p-4 md:p-6">
        <div className="space-y-8">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <Can I="create" a="category">
              <div className="flex space-x-2">
                <CategoryMutateDialog mode="create" parentId={createParentId} onOpenChange={handleCreateOpenChange} />
                <CategoryBulkCreate />
              </div>
            </Can>
          </div>
          ...
          {editing && (
            <CategoryMutateDialog mode="edit" category={editing} onDone={cancelEdit} />
          )}
